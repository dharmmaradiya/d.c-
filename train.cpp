...
int main()
{
    ...
    if (choiceno == 2)
    {
        ...
        t[0].setdetail(1, "vande bharat_express", "ahmedabad", "Rajasthan", "08:10 pm");
        t[1].setdetail(2, "vande bharat", "ahmedabad", "Rajasthan", "09:25 pm");
        t[2].setdetail(3, "vande bharat", "ahmedabad", "Rajasthan", "11:15 pm");
        t[3].setdetail(4, "vande bharat", "ahmedabad", "Rajasthan", "12:30 pm");
        t[4].setdetail(5, "vande bharat", "ahmedabad", "Rajasthan", "07:45 am");
    ...
    if (choiceno == 3)
    {
        ...
        trainrecords t[5] = {
            trainrecords(1906, "vande bharat _express", "ahmedabad", "indore", "08:10 pm"),
            trainrecords(19062, "vande bharat_express", "ahmedabad", "mautabu", "09:25 pm"),
            trainrecords(190620, "vande bharat_express", "ahmedabad", "udaipur", "11:15 pm"),
            trainrecords(190628, "vande bharat_express", "ahmedabad", "kanpur", "12:30 pm"),
            trainrecords(10965, "vande bharat_express", "ahmedabad", "manali", "07:45 am")};
